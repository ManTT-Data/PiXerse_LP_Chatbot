"""
MCP Tools for Strapi Schema
Updated tools to work with new Strapi-like database schema
"""
...
mcp_server = FastMCP("Pixerse-Strapi-MCP")
    ...
    async with async_session() as db:
        try:
            ...
            if blog:
                ...
                # Add related data
                if blog.users:
                    blog_dict['users'] = [{'id': u.id, 'username': u.username} for u in blog.users]
                if blog.project:
...
async def get_blogs_list(limit: int = 50, offset: int = 0, published_only: bool = False):
...
async def search_blogs_by_keyword(keyword: str, limit: int = 50, offset: int = 0):
...
async def get_members_list(limit: int = 50, offset: int = 0, published_only: bool = False):
...
async def search_members_by_keyword(keyword: str, limit: int = 50, offset: int = 0):
...
async def get_projects_list(limit: int = 50, offset: int = 0, published_only: bool = False):
...
async def search_projects_by_keyword(keyword: str, limit: int = 50, offset: int = 0):
