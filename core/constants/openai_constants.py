...
- Pix.teq → Technology services: AI, Blockchain, Outsourcing, Security.
- Pix.stdio → Creative services: Branding, Design, Media, Marketing, Events.
...
- Founders: Giang (Business/Research), Sơn (Cybersecurity/Media), Lĩnh (CTO/Tech).
...
Members (id, name, role, projects, blogs, summary, experience).
